...
final class DateAndTime {
     ...
     * @note The valid range of a timestamp is typically from Fri, 13 Dec 1901 20:45:54 UTC to
     * Tue, 19 Jan 2038 03:14:07 UTC. (These are the dates that correspond to the minimum and maximum values for a
     ...
     * Negative values reference the minute in the previous hour. Values greater than 59 reference
     ...
     * Values greater than the number of days in the relevant month reference the appropriate
     ...
     * @uses \FireHub\Core\Support\LowLevel\Data::setType() To set microtime to other type.
