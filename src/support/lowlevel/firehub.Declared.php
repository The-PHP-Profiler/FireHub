...
final class Declared {
     ...
     * @since 1.0.0
     *
     * @return array<class-string> Array of the names of the declared interfaces in the current script.
     */
     ...
     * @since 1.0.0
     *
     * @return array<class-string> Array of the names of the declared traits in the current script.
     */
     ...
     * </p>
     *
     * @return ($categorize is true ? array<string, array<non-empty-string, mixed>> : array<non-empty-string, mixed>)
     ...
     * </p>
     *
     * @return array{internal: non-empty-array<int, callable-string>, user: array<int, callable-string>} A
     * multidimensional array containing a list of all
     * defined functions, both built-in (internal) and user-defined. The internal functions will be accessible via
