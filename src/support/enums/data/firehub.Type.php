...
enum Type implements MasterEnum {
     ...
     * @since 1.0.0
     *
     * @uses \FireHub\Core\Support\Enums\Data\Category::SCALAR As data type category.
     * @uses \FireHub\Core\Support\Enums\Data\Category::COMPOUND As data type category.
     * @uses \FireHub\Core\Support\Enums\Data\Category::SPECIAL As data type category.
     *
